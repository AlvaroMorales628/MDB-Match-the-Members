...
class GameScreenView: UIViewController {
    ...
    //[M1, M2, M3] For visualization, Delete later
    //[IC, C, IC]
    
    override func viewDidLoad() {
        super.viewDidLoad()
        //print("Loading Game View")
        userScore = 0
    ...
    func buttonPressed(buttonNumber: Int) {
        ...
        // CLEANUP: Reflect on if this is the best method of making a pause
    ...
    @IBAction func statisticsPressed(_ sender: Any) {
        //print("CurrentStreak: " + String(CurrentStreak))
        //print("LongestStreak: " + String(LongestStreak))
    ...
    /*
    func onesecondTimer() {
        oneSecondTimer = Timer.scheduledTimer(timeInterval: 1, target: self,   selector: (#selector(GameScreenView.oneSecondUpdateTimer)), userInfo: nil, repeats: true)
        self.view.isUserInteractionEnabled = false
    }
    
    @objc func oneSecondUpdateTimer() {
